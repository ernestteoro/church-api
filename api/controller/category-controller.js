...
exports.get_all_categories =(req,res,next)=>{
    ...
    if(cat_id){
        CategoryModel.findById(cat_id).select('_id title description created').exec().then(category=>{
        ...
        CategoryModel.find().select('_id title description created').exec().then(categories=>{
